    ...
    <footer className="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">French Voyage Akademie</h3>
            <p className="text-gray-600 dark:text-gray-300">
              Your journey to French fluency starts here. Learn French with our comprehensive online courses.
            </p>
          </div>
          ...
          <div>
            ...
            <address className="not-italic text-gray-600 dark:text-gray-300">
              <p>Email: info@frenchvoyage.com</p>
        ...
        <div className="mt-8 border-t border-gray-200 dark:border-gray-800 pt-8 text-center">
          <p className="text-gray-600 dark:text-gray-300">
            &copy; {new Date().getFullYear()} French Voyage Akademie. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
